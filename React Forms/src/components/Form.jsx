...
function Form(){
    ...
    return(
        ...
        <form className="form" onSubmit={handleSubmit}>
            <input onChange={handleChange} name="username" type="text" placeholder="Enter Name" required/>
            ...
            <label>
                Married 
                <input onChange={handleChange} name="isMarried" type="checkbox" value="isMarried" required/>
            </label>
